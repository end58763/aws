...
#echo "Adding ubuntu user to sudoers"
#sudo tee /etc/sudoers.d/ubuntu > /dev/null <<"EOF"
...
sudo chown -R ubuntu Hands-on-with-container-orchestration-using-Docker-Swarm-and-Kubernetes
